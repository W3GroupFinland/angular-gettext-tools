...
var Extractor = (function () {
    ...
    Extractor.prototype.toString = function (orig) {
        if(orig) {
        ...
        Object.keys(orig).forEach(function (key) {
            if (!orig[key].internal) {
                orig[key].obsolete = true;
            }
        });
        ...
        for (var msgstr in this.strings) {
            ...
            var origMsg = orig[msgstr];
            if (origMsg) {
                origMsg.obsolete = false;
                origMsg.references = msg.$$noContext.references
            } else {
                orig[msgstr] = {obsolete: false, references: msg.$$noContext.references};
            }
